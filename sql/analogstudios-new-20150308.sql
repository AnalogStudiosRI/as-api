CREATE DATABASE  IF NOT EXISTS `asadmin_analogstudios_new` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `asadmin_analogstudios_new`;
-- MySQL dump 10.13  Distrib 5.6.13, for osx10.6 (i386)
--
-- Host: localhost    Database: asadmin_analogstudios_new
-- ------------------------------------------------------
